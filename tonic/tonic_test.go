...
type bodyIn struct {
	Param                  string `json:"param" validate:"required" yaml:"param" form:"param"`
	ParamOptional          string `json:"param-optional" yaml:"param-optional" form:"param-optional"`
	ValidatedParamOptional string `json:"param-optional-validated" validate:"eq=|eq=foo|gt=10" yaml:"param-optional-validated" form:"param-optional-validated"`
}
